...
export class GenAIService {
     ...
     */
    public async generateContent(prompt: string, temperature: number = 0.7, maxOutputTokens: number = 500, systemInstruction: string = 'You are a helpful coding assistant') {
        this.init();
